...
@section('title', 'ajouter un autre depense')
                    ...
                    <div class="row">
                            <div class="col-md-9">
                                  <div class="card">
                                          ...
                                          <form class="form-horizontal" action="/Insert_Autreparam" method="post" enctype="multipart/form-data">
                                          @csrf
                                                <div class="card-body">
                                                      <h4 class="card-title">Ajouter un autre depense</h4>
